...
class HJBConfig(Config):
    ...
    lr_boundaries = [400]
    num_iterations = 2000
    lr_values = list(np.array([1e-3, 1e-2]))
    num_hiddens = [dim, dim+10, dim+10, dim]
    y_init_range = [0, 1]

class HJB1Config(Config):
    # Y_0 is about 4.5901.
    dim = 100
    total_time = 1.
    num_time_interval = 20
...
class toy1dConfig(Config):
    dim = 1
    total_time = 2.0
    num_time_interval = 120
    lr_values = list(np.array([5e-3]))
    lr_boundaries = [8000, 16000]
    num_iterations = 1000
    num_hiddens = [dim, dim+10, dim+10, dim]
    # y_init_range = [1, 2]
    
class BSConfig(Config):
    # Y_0 is about 4.5901.
    dim = 1
    total_time = 1.0
    num_time_interval = 120
...
class MertonConfig(Config):
    ...
    lr_boundaries = [400]
    num_iterations = 2000
    lr_values = list(np.array([1e-5, 5e-3]))
    num_hiddens = [dim, dim+10, dim+10, dim]
    y_init_range = [0, 1]    
